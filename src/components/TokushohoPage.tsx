...
const TokushohoPage: React.FC = () => {
  ...
  const sections = [
    ...
    {
      title: '所在地',
      content: '〒222-0011\n神奈川県横浜市港北区菊名3-3-8サンクレスト菊名202号室'
    },
    {
      title: '連絡先',
      content: '営業時間：平日 10:00〜18:00（土日祝休み）\n電話番号：070-3536-1964\n※お電話でのサポートは行っておりません。お問い合わせはメールにてお願いいたします。\n\nメールアドレス：wassa0969@gmail.com'
    },
    {
      title: '販売価格',
    ...
    {
      title: '返品・不良品等の対応',
      content: '＜お客様都合の返品・キャンセル＞\nデジタルコンテンツという商品の特性上、購入後の返品・返金・キャンセルはお受けできません。\nサブスクリプションの解約は、ユーザー設定画面からいつでも可能です。解約手続き完了後、次回以降の請求は発生しません。\n\n＜システムの不具合等（不良品）による対応＞\nシステム障害等によりサービスが正常にご利用いただけない場合は、お問い合わせ窓口（メール）までご連絡ください。状況調査の上、不具合の解消または返金等の対応をさせていただきます。'
    },
    {
      title: '動作環境',
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans">
      <title>特定商取引法に基づく表記 | MathStudio</title>
